    ...
    <div className="bg-custom-light backdrop-blur-sm border border-gray-700/50 rounded-xl p-6 shadow-lg mb-4">
      <section className="flex flex-col gap-3">
        ...
        <p className="text-custom-slate">
          ...
          around the world. I have experience working with startups, small
          businesses and large corporations, helping them build web apps that
          meet their needs.
        </p>
        <p className="text-custom-slate">
